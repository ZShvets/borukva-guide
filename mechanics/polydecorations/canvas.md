...
<center><img src="/public/images/mechanics/canvas/canvas.png" alt="Полотно" /></center>
...
<div class="div-pallete-canvas">
    <img src="/public/images/mechanics/canvas/canvas_colors.png" alt="Палітра" class="img-canvas img-pallete-canvas"></img>
    <p>Всі доступні для канвасів кольори</p>
</div>
...
Щітка (ванільна) дозволяє використовувати предмет (*Наприклад: барвник, губку і тп.*) в лівій руці по площі 3x3 пікселя на полотні

<center>
    <img src="/public/images/mechanics/canvas/brush_canvas.png" alt="3на3 за допомогою щітки" class="img-canvas img-brush-canvas"></img>
    <p>Зліва - 1 натискання без щітки, справа - з нею</p>
</center>
